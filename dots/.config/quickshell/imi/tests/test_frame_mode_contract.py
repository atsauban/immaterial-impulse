...
class FrameModeContract(unittest.TestCase):
    ...
    def test_one_geometry_authority(self):
        ...
        self.assertIn("readonly property bool islandsHug: root.frameHug && root.isFloatIslands", bar)
        ...
        self.assertIn("frameHug: FrameGeometry.enabled && barRoot.joinAttached", barWindow)
